def print_data(data, search = False):
    if len(data) > 0:
        print("id".center(5), "Фамилия".center(20), "Имя".center(10), "Факультет".center(10), "Статус".center(40),\
           "ряд".center(4), "парта".center(6),\
            "Город".center(15), "Улица".center(15), "Дом".center(6), "Квартира".center(4), "Примечание".center(6))
        print("-")
        if not search:
            del data[0]
        for item in data:
